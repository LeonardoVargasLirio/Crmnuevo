        ...
        <div class="card-header border-0 pt-6">
            <div class="card-title">
                <div class="d-flex align-items-center position-relative my-1">
                    <input type="text" data-kt-subscription-table-filter="search" class="form-control form-control-solid w-250px ps-12" placeholder="Buscar empresas" />
                </div>
            </div>
            <div class="card-toolbar">
                <div class="d-flex justify-content-end" data-kt-subscription-table-toolbar="base">
                    ...
                    <a href="{{ route('crearempresa') }}" class="btn btn-primary">
                        <i class="ki-duotone ki-plus fs-2"></i>Crear Empresa</a>
                </div>
            </div>
        </div>
        ...
        <div class="card-body pt-0">
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_subscriptions_table">
                ...
                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                    ...
                    <th class="min-w-125px">Direccio de correo</th>
                ...
                @foreach($empresa as $empresa)
                    <tr>
                        ...
                        <td>{{$empresa->fechaasignacion}}</td>
                        <td>{{$empresa->idfuente}}</td>
