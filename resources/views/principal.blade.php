                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #F1416C;background-image:url('assets/media/svg/shapes/wave-bg-red.svg')">
                            ...
                            <div class="card-body d-flex align-items-end mb-3">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="fw-bold fs-6 text-white">
                                        <span class="d-block">Llamadas</span>
                                        <span class="">Entrantes</span>
                                    </div>
                                </div>
                                <!--end::Info-->
                            </div>
                            ...
                            <div class="card-footer" style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
                                ...
                                <div class="fw-bold text-white py-2">
                                    ...
                                    <span class="opacity-50">Problemas Resueltos</span>
                                </div>
                                <!--end::Progress-->
                            </div>
                            <!--end::Card footer-->
                        ...
                        <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-xl-100" style="background-color: #7239EA;background-image:url('assets/media/svg/shapes/wave-bg-purple.svg')">
                            ...
                            <div class="card-footer" style="border-top: 1px solid rgba(255, 255, 255, 0.3);background: rgba(0, 0, 0, 0.15);">
                                ...
                                <div class="fw-bold text-white py-2">
                                    ...
                                    <span class="opacity-50">Leads Generados</span>
                                </div>
                                <!--end::Progress-->
                            </div>
                            <!--end::Card footer-->
                        ...
                        <div class="card card-flush overflow-hidden h-lg-100">
                            ...
                            <div class="card-header pt-5">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-dark">CRM Analisis</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">1,046 Llamadas Diarias</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                    ...
                                    <div class="col-7 px-0">
                                        ...
                                        <div class="d-flex flex-column content-justify-center">
                                            ...
                                            <div class="d-flex fs-6 fw-semibold align-items-center">
                                                ...
                                                <!--end::Bullet-->
                                                <!--begin::Label-->
                                                <div class="fs-5 fw-bold text-gray-600 me-5">CRM El rendimiento del equipo:</div>
                                                <!--end::Label-->
                                                <!--begin::Stats-->
                                            ...
                                            <div class="d-flex fs-6 fw-semibold align-items-center my-4">
                                                ...
                                                <!--end::Bullet-->
                                                <!--begin::Label-->
                                                <div class="fs-5 fw-bold text-gray-600 me-5">Llamadas recurrentes:</div>
                                                <!--end::Label-->
                                                <!--begin::Stats-->
                                            ...
                                            <div class="d-flex fs-6 fw-semibold align-items-center">
                                                ...
                                                <!--end::Bullet-->
                                                <!--begin::Label-->
                                                <div class="fs-5 fw-bold text-gray-600 me-5">Llamadas levantados:</div>
                                                <!--end::Label-->
                                                <!--begin::Stats-->
                                    ...
                                    <div class="col-sm-7 pe-0 mb-5 mb-sm-0">
                                        ...
                                        <div class="d-flex justify-content-between h-100 flex-column pt-xl-5 pb-xl-2 ps-xl-7">
                                            ...
                                            <div class="mb-7">
                                                <!--begin::Title-->
                                                <div class="mb-6">
                                                    <h3 class="fs-2x fw-semibold text-white">Actualice su plan</h3>
                                                    <span class="fw-semibold text-white opacity-75">Caricaturas planas e ilustraciones con colores vivos.</span>
                                                </div>
                                                <!--end::Title-->
                                                <!--begin::Items-->
                                                <div class="d-flex align-items-center flex-wrap d-grid gap-2">
                                                    ...
                                                    <div class="d-flex align-items-center me-5 me-xl-13">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="m-0">
                                                            <a href="../../demo8/dist/pages/user-profile/projects.html" class="text-white text-opacity-75 fs-8">Projects</a>
                                                            <span class="fw-bold text-white fs-7 d-block">Hasta 500</span>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::Item-->
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <!--begin::Info-->
                                                        <div class="m-0">
                                                            <a href="../../demo8/dist/apps/user-management/users/list.html" class="text-white text-opacity-75 fs-8">Tasks</a>
                                                            <span class="fw-bold text-white fs-7 d-block">Ilimitado</span>
                                                        </div>
                                                        <!--end::Info-->
                                                    </div>
                                                    <!--end::Item-->
                                            ...
                                            <!--begin::Action-->
                                            <div class="m-0">
                                                <a href="#" class="btn btn-color-white bg-white bg-opacity-15 bg-hover-opacity-25 fw-semibold" data-bs-toggle="modal" data-bs-target="#kt_modal_upgrade_plan">Actualizacion del Plan</a>
                                            </div>
                                            <!--begin::Action-->
                                        </div>
                                        <!--end::Wrapper-->
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-header pt-5 mb-6">
                                ...
                                <h3 class="card-title align-items-start flex-column">
                                    ...
                                    <!--end::Statistics-->
                                    <!--begin::Description-->
                                    <span class="fs-6 fw-semibold text-gray-400">Promedio Ganancias del agente</span>
                                    <!--end::Description-->
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Nuevo billete</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Nuevo cliente</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3" data-kt-menu-trigger="hover" data-kt-menu-placement="right-start">
                                            ...
                                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Grupo de administración</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Grupo de personal</a>
                                                </div>
                                                <!--end::Menu item-->
                                                <!--begin::Menu item-->
                                                <div class="menu-item px-3">
                                                    <a href="#" class="menu-link px-3">Grupo de miembros</a>
                                                </div>
                                                <!--end::Menu item-->
                                            </div>
                                            <!--end::Menu sub-->
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3">Nuevo contacto</a>
                                        </div>
                                        <!--end::Menu item-->
                                        <!--begin::Menu separator-->
                                        ...
                                        <div class="menu-item px-3">
                                            <div class="menu-content px-3 py-3">
                                                <a class="btn btn-primary btn-sm px-4" href="#">Generar informes</a>
                                            </div>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="card card-flush h-lg-100">
                            ...
                            <div class="card-header pt-7">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bold text-gray-800">Estadísticas de proyectos</span>
                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">Actualizado hace 37 minutos</span>
                                </h3>
                                <!--end::Title-->
                                <!--begin::Toolbar-->
                                <div class="card-toolbar">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-row-dashed align-middle gs-0 gy-3 my-0">
                                        ...
                                        <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                            <th class="p-0 pb-3 min-w-175px text-start">ARTÍCULO</th>
                                            <th class="p-0 pb-3 min-w-100px text-end">LLAMADAS</th>
                                            <th class="p-0 pb-3 min-w-100px text-end">CRP RANGO</th>
                                            <th class="p-0 pb-3 min-w-150px text-end pe-12">PROGRESO</th>
                                            <th class="p-0 pb-3 w-125px text-end pe-7">CUADRO</th>
                                            <th class="p-0 pb-3 w-50px text-end">VISTA</th>
                                        </tr>
                                        </thead>
                                        <!--end::Table head-->
                                        <!--begin::Table body-->
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="../../demo8/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Guy Hawkins</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="../../demo8/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jane Cooper</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="../../demo8/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Jacob Jones</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="../../demo8/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Esther Howard</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="d-flex justify-content-start flex-column">
                                                        <a href="../../demo8/dist/apps/projects/users.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Ralph Edwards</a>
